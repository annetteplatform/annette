...
object SchemaSerializerRegistry extends JsonSerializerRegistry {
  override def serializers =
    List(
      JsonSerializer[ActiveIndexParamState],
      JsonSerializer[ActiveSchemaAttributeState],
      JsonSerializer[SchemaState],
      JsonSerializer[ActiveAttributeNameUpdate],
      JsonSerializer[PreparedIndexParam],
      JsonSerializer[PreparedSchemaAttribute],
      JsonSerializer[ActiveIndexParam],
      JsonSerializer[ActiveSchemaAttribute],
      ...
      JsonSerializer[SchemaEntity.ActiveAttributeNameUpdated],
