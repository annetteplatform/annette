...
object RoleAlreadyExist extends AnnetteTransportExceptionCompanion {
  ...
  val MessageCode = "annette.authorizationService.role.roleAlreadyExist"
}

object RoleNotFound extends AnnetteTransportExceptionCompanion {
  val ErrorCode   = TransportErrorCode.NotFound
  val MessageCode = "annette.authorizationService.role.roleNotFound"
}
