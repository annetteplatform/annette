...
package biz.lobachev.annette.blogs.impl.category

import biz.lobachev.annette.blogs.impl.category.dao.CategoryElasticIndexDao
...
private[impl] class CategoryIndexEventProcessor(
  ...
  def buildHandler() =
    readSide
      .builder[CategoryEntity.Event]("Blogs_Category_ElasticEventOffset")
