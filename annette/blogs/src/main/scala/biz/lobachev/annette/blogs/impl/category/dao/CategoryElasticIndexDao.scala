...
package biz.lobachev.annette.blogs.impl.category.dao

import biz.lobachev.annette.blogs.api.category.CategoryFindQuery
import biz.lobachev.annette.blogs.impl.category.CategoryEntity
...
class CategoryElasticIndexDao(elasticSettings: ElasticSettings, elasticClient: ElasticClient)(implicit
  ...
  override def indexSuffix = "blogs-category"
  ...
  def deleteCategory(event: CategoryEntity.CategoryDeleted): Future[Unit] =
    elasticClient.execute {
