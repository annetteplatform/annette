...
trait AnnetteTransportExceptionCompanion3 {
  ...
  def unapply(ex: Exception): Option[(String, String, String)] =
    ex match {
      case ate: AnnetteTransportException
        ...
        Some((ate.params(Arg1Key), ate.params(Arg2Key), ate.params(Arg3Key)))
      case _ => None
    }
}
