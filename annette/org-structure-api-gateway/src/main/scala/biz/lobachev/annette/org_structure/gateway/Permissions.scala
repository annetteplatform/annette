...
object Permissions {
  ...
  final def VIEW_ORG_HIERARCHY(orgId: CompositeOrgItemId)     = Permission(VIEW_ORG_HIERARCHY_PERMISSION_ID, orgId)
  ...
  final def MAINTAIN_ORG_HIERARCHY(orgId: CompositeOrgItemId) = Permission(MAINTAIN_ORG_HIERARCHY_PERMISSION_ID, orgId)
