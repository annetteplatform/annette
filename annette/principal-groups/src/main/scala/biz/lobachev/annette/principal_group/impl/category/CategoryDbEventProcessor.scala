...
import biz.lobachev.annette.principal_group.impl.category.dao.CategoryCassandraDbDao
...
private[impl] class CategoryDbEventProcessor(
  ...
  def buildHandler() =
    readSide
      .builder[CategoryEntity.Event]("PrincipalGroup_Category_CasEventOffset")
