...
object SubscriptionNotFound extends AnnetteTransportExceptionCompanion3 {
  ...
  val MessageCode     = "annette.subscriptionService.subscription.notFound"
  val Arg1Key: String = "type"
  val Arg2Key: String = "objectId"
  val Arg3Key: String = "principal"
}

object SubscriptionAlreadyExist extends AnnetteTransportExceptionCompanion3 {
  val ErrorCode       = TransportErrorCode.BadRequest
  val MessageCode     = "annette.subscriptionService.subscription.alreadyExist"
  val Arg1Key: String = "type"
  val Arg2Key: String = "objectId"
  val Arg3Key: String = "principal"
}
