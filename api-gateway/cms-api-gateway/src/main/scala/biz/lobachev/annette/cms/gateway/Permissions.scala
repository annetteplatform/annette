...
object Permissions {
  ...
  final val FIND_ALL_BLOGS               = Permission("annette.cms.blog.find.all")
  final val MAINTAIN_ALL_POSTS           = Permission("annette.cms.post.maintain.all")
  final val FIND_ALL_POSTS               = Permission("annette.cms.post.find.all")
  ...
  final val FIND_ALL_SPACES               = Permission("annette.cms.space.find.all")
  final val MAINTAIN_ALL_PAGES            = Permission("annette.cms.page.maintain.all")
  final val FIND_ALL_PAGES                = Permission("annette.cms.page.find.all")
