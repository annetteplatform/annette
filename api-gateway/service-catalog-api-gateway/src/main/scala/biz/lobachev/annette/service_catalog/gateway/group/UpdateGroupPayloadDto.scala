...
case class UpdateGroupPayloadDto(
  id: GroupId,
  name: Option[String],
  ...
  services: Option[Seq[ServiceItemId]]
)

object UpdateGroupPayloadDto {
  implicit val format: Format[UpdateGroupPayloadDto] = Json.format
}
