...
object LanguageAlreadyExist extends AnnetteTransportExceptionCompanion {
  ...
  val MessageCode = "annette.applicationService.language.languageAlreadyExist"
}

object LanguageNotFound extends AnnetteTransportExceptionCompanion {
  val ErrorCode   = TransportErrorCode.NotFound
  val MessageCode = "annette.applicationService.language.languageNotFound"
}
