...
package biz.lobachev.annette.service_catalog.service.service_principal.model
...
object ServicePrincipalSerializerRegistry extends JsonSerializerRegistry {
  override def serializers =
    List(
      // state
      JsonSerializer[ServicePrincipalEntity],
      ...
      JsonSerializer[UnassignServicePrincipalPayload],
      JsonSerializer[AssignServicePrincipalPayload],
      // responses
