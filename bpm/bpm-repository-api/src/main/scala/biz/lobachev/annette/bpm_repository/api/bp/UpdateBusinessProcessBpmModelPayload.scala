...
case class UpdateBusinessProcessBpmModelPayload(
  id: BusinessProcessId,
  bpmModelId: Option[BpmModelId],
  updatedBy: AnnettePrincipal
)

object UpdateBusinessProcessBpmModelPayload {
  implicit val format = Json.format[UpdateBusinessProcessBpmModelPayload]
}
