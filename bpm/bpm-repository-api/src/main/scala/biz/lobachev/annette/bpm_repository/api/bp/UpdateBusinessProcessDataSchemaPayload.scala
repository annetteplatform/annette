...
case class UpdateBusinessProcessDataSchemaPayload(
  id: BusinessProcessId,
  dataSchemaId: Option[DataSchemaId],
  updatedBy: AnnettePrincipal
)

object UpdateBusinessProcessDataSchemaPayload {
  implicit val format = Json.format[UpdateBusinessProcessDataSchemaPayload]
}
