...
object DataSchemaAlreadyExist extends AnnetteTransportExceptionCompanion1 {
  val ErrorCode       = TransportErrorCode.InternalServerError
  val MessageCode     = "annette.bpm.dataSchema.alreadyExist"
  val Arg1Key: String = "id"
}

object DataSchemaNotFound extends AnnetteTransportExceptionCompanion1 {
  val ErrorCode       = TransportErrorCode.NotFound
  val MessageCode     = "annette.bpm.dataSchema.notFound"
  val Arg1Key: String = "id"
}
