...
private[impl] class PostIndexEventProcessor(
  ...
  def buildHandler(): ReadSideProcessor.ReadSideHandler[PostEntity.Event] =
    readSide
      ...
      .setEventHandler[PostEntity.PostWidgetContentUpdated](handle(indexDao.updatePostWidgetContent))
      .setEventHandler[PostEntity.WidgetContentOrderChanged](handle(indexDao.changeWidgetContentOrder))
      .setEventHandler[PostEntity.WidgetContentDeleted](handle(indexDao.deleteWidgetContent))
