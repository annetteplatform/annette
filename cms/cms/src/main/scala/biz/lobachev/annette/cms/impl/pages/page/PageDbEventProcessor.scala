...
private[impl] class PageDbEventProcessor(
  ...
  def buildHandler(): ReadSideProcessor.ReadSideHandler[PageEntity.Event] =
    readSide
      ...
      .setEventHandler[PageEntity.ContentSettingsUpdated](handle(dbDao.updateContentSettings))
      .setEventHandler[PageEntity.PageWidgetUpdated](handle(dbDao.updatePageWidget))
      .setEventHandler[PageEntity.WidgetOrderChanged](handle(dbDao.changeWidgetOrder))
      .setEventHandler[PageEntity.WidgetDeleted](handle(dbDao.deleteWidget))
