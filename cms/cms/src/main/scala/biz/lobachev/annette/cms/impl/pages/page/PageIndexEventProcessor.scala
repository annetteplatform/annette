...
private[impl] class PageIndexEventProcessor(
  ...
  def buildHandler(): ReadSideProcessor.ReadSideHandler[PageEntity.Event] =
    readSide
      ...
      .setEventHandler[PageEntity.WidgetContentOrderChanged](handle(indexDao.changeWidgetContentOrder))
      .setEventHandler[PageEntity.WidgetContentDeleted](handle(indexDao.deleteWidgetContent))
