...
import biz.lobachev.annette.microservice_core.pekko.db.CassandraTableBuilder.ColumnDefinition
import biz.lobachev.annette.microservice_core.pekko.db.CassandraTableBuilder.types.CassandraDataType
