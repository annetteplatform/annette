...
package biz.lobachev.annette.ignition.cms.loaders.data
...
case class PageData(
  ...
  authorId: String,
  title: String,
  publicationStatus: Option[String] = None,
  publicationTimestamp: Option[String] = None,
  content: Option[Content] = None
)

object PageData {
  implicit val format = Json.format[PageData]
}
