...
object EmptyHierarchy extends HierarchyState {
  ...
  override def applyCommand(cmd: Command): ReplyEffect[Event, HierarchyState] =
    cmd match {
      ...
      // TODO: orgId should be extracted from unitId/positionId/itemId
      case cmd: CreateUnit              => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.unitId))
      case cmd: CreatePosition          => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: UpdateName              => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
      case cmd: AssignCategory          => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
      case cmd: UpdateSource            => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
      case cmd: UpdateExternalId        => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
      case cmd: MoveItem                => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
      case cmd: AssignChief             => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.unitId))
      case cmd: UnassignChief           => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.unitId))
      case cmd: ChangePositionLimit     => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: AssignPerson            => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: UnassignPerson          => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: AssignOrgRole           => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: UnassignOrgRole         => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: DeleteOrgItem           => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
      case cmd: GetOrgItem              => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.id))
      case cmd: GetOrganization         => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.orgId))
      case cmd: GetOrganizationTree     => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
      case cmd: GetChildren             => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.unitId))
      case cmd: GetPersons              => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: GetRoles                => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.positionId))
      case cmd: GetRootPaths            => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemIds.mkString(",")))
      case cmd: GetOrgItemAttributes    => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.id))
      case cmd: UpdateOrgItemAttributes => Effect.reply(cmd.replyTo)(OrganizationNotFound(cmd.itemId))
    }
